...
public class UIUtilities {
    ...
    public static func addLineSegment(
        ...
        lineLayer.strokeColor = UIColor.blue.cgColor//color.cgColor
    ...
    public static func createPoseOverlayView(
        ...
        for (startLandmarkType, endLandmarkTypesArray) in UIUtilities.poseConnections() {
            ...
            for endLandmarkType in endLandmarkTypesArray {
                ...
                if (startLandmark == pose.landmark(ofType: .mouthLeft)) || (endLandmark == pose.landmark(ofType: .mouthRight)) || (startLandmark == pose.landmark(ofType: .nose)) || (endLandmark == pose.landmark(ofType: .nose)) || (startLandmark == pose.landmark(ofType: .rightEye)) || (endLandmark == pose.landmark(ofType: .rightEye)) || (startLandmark == pose.landmark(ofType: .leftEye)) || (endLandmark == pose.landmark(ofType: .leftEye)) || (startLandmark == pose.landmark(ofType: .leftEar)) || (endLandmark == pose.landmark(ofType: .leftEar)) || (startLandmark == pose.landmark(ofType: .rightEar)) || (endLandmark == pose.landmark(ofType: .rightEar)) || (startLandmark == pose.landmark(ofType: .rightPinkyFinger)) || (endLandmark == pose.landmark(ofType: .rightPinkyFinger)) || (startLandmark == pose.landmark(ofType: .rightThumb)) || (endLandmark == pose.landmark(ofType: .rightThumb)) || (startLandmark == pose.landmark(ofType: .leftPinkyFinger)) || (endLandmark == pose.landmark(ofType: .leftPinkyFinger)) || (startLandmark == pose.landmark(ofType: .leftThumb)) || (endLandmark == pose.landmark(ofType: .leftThumb)) {
                    
                    print("Do not draw line for points")
                } else{
                    // Here the line color will be changed
                    UIUtilities.addLineSegment(
                        fromPoint: startLandmarkPoint,
                        toPoint: endLandmarkPoint,
                        inView: overlayView,
                        colors: [UIColor.fenrisBlue, UIColor.fenrisBlue],
                        width: lineWidth)
                }
            }
        }
        
        // Here the dot color will be changed
        for landmark in pose.landmarks {
            
            let landmarkPoint = positionTransformationClosure(landmark.position)
            var color = UIColor.red
            
            if landmark == pose.landmark(ofType: .rightEye){
                color = .clear
            }
            
            if landmark == pose.landmark(ofType: .leftEye){
                color = .clear
            }
            
            if (landmark == pose.landmark(ofType: .mouthLeft)) || (landmark == pose.landmark(ofType: .mouthRight)){
                color = .clear
            }
            
            if landmark == pose.landmark(ofType: .nose){
                color = .clear
            }
            
            if landmark == pose.landmark(ofType: .rightEar){
                color = .clear
            }
            
            if landmark == pose.landmark(ofType: .leftEar){
                color = .clear
            }
            
            if landmark == pose.landmark(ofType: .leftEyeInner) || landmark == pose.landmark(ofType: .leftEyeOuter) || landmark == pose.landmark(ofType: .rightEyeInner) || landmark == pose.landmark(ofType: .rightEyeOuter)  {
                color = .clear
            }
            
            if landmark == pose.landmark(ofType: .leftPinkyFinger) || landmark == pose.landmark(ofType: .leftThumb) {
                color = .clear
            }
            
            if landmark == pose.landmark(ofType: .rightPinkyFinger) || landmark == pose.landmark(ofType: .rightThumb) {
                color = .clear
            }
