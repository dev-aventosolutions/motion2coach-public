...
class RecordingDownTheLineVC: BaseVC {
...
//------------------------------------
extension RecordingDownTheLineVC : UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        self.navigateForward(storyBoard: SBRecordings, viewController: recordingDownTheLineImageVCID)
    }
}
