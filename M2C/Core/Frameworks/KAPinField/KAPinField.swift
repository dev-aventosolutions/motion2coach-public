...
extension KAPinField{
    public func customisePinField(){
        self.appearance.font = .menloBold(40) // Default to appearance.MonospacedFont.menlo(40)
        self.appearance.kerning = 35 // Space between characters, default to 16
        self.appearance.textColor = .fenrisBlue // Default to nib color or black if initialized programmatically.
        self.appearance.tokenColor = .fenrisBlue // token color, default to text color
        self.appearance.tokenFocusColor = .fenrisBlue  // token focus color, default to token color
        self.appearance.backOffset = 10 // Backviews spacing between each other
        self.appearance.backColor = UIColor.clear
        self.appearance.backBorderWidth = 1
        self.appearance.backBorderColor = .clear
        self.appearance.backCornerRadius = 4
        self.appearance.backFocusColor = UIColor.clear
        self.appearance.backBorderFocusColor = UIColor.white.withAlphaComponent(0.8)
        self.appearance.backActiveColor = UIColor.clear
        self.appearance.backBorderActiveColor = UIColor.white
        
        
        self.properties.token = "_" // Default to "•"
        self.properties.numberOfCharacters = 5 // Default to 4
        self.properties.validCharacters = "0123456789+#?" // Default to only numbers, "0123456789"
        //        pinf.properties.text = "123" // You can set part or all of the text
        self.properties.animateFocus = true // Animate the currently focused token
        self.properties.isSecure = true // Secure pinField will hide actual input
        self.properties.secureToken = "•" // Token used to hide actual character input when using isSecure = true
