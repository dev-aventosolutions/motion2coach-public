...
//    static let inputHeight = 416
    ...
    // model output is of size 16800*6
    //    static let outputRow = 16800 // YOLOv5 모델 input size 640 * 640 기준 output Row 값 25200
    //    static let outputColumn = 6 // 클래스 수 + 5 (left, top, right, bottom, score) 값
    
    // For our custom model
    // model output is of size 7098*6
    // This is for 416 x 416
//    static let outputRow = 7098 // YOLOv5 model input size 416 * 416 standard output Row value 25200
//    static let outputColumn = 6 // Number of classes + 5 (left, top, right, bottom, score) value

    
    // model output is of size 16800*6
    // This is for 640 x 640
    static let outputRow = 16800 // YOLOv5 model input size 640 * 640 standard output Row value 25200
    static let outputColumn = 6 // Number of classes + 5 (left, top, right, bottom, score) value
    
    
    static let threshold : Float = 0.6 // 객체 탐지를 진행하는 최소한의 임계값 35%
