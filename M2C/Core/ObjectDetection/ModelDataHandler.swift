...
//    static let labelsInfo: FileInfo = (name: "classes", extension: "txt")
    ...
    // For Ball only 640x640
    static let modelInfo: FileInfo = (name: "best_944-fp16", extension: "tflite")
    static let labelsInfo: FileInfo = (name: "BallClass", extension: "txt")
    
    // For Ball only 416x416
...
//        guard let scaledPixelBuffer = pixelBuffer.crop(to: CGRect(origin: .zero, size: scaledSize)) else {
//            return nil
//        }
