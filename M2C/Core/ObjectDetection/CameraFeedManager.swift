...
class CameraFeedManager: NSObject {
    ...
    init(previewView: PreviewView) {
        ...
        //        self.previewView.session?.sessionPreset = .hd1920x1080
...
/**
 AVCaptureVideoDataOutputsSampleBufferDelegate
 */
...
//        guard let imagePixelBuffer = pixelBuffer?.rotate90Degree() else { return }
