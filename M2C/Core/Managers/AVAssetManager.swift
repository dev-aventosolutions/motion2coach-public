...
//  M2C
//
//  Created by Abdul Samad Butt on 08/11/2022.
//
...
class AVAssetManager{
    ...
    func cropVideoTrack(asset: AVAsset, at index: Int, cropRect: CGRect, outputURL: URL, completion: @escaping (String) -> ()) {
